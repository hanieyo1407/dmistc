...
export const clubMembers: ClubMember[] = [
    ...
    createMockUser(4, 'Liam Goldberg', 'liam.g@dmistc.com', 'EXECUTIVE', 'CHAIRPERSON'),
    createMockUser(5, 'Sophia Chen', 'sophia.c@dmistc.com', 'EXECUTIVE', 'PROJECT_COORDINATOR'),
    createMockUser(6, 'Noah Kim', 'noah.k@dmistc.com', 'EXECUTIVE', 'TREASURER'),
    ...
    createMockUser(8, 'Dr. Alan Grant', 'alan.g@dmistc.com', 'ADVISOR'),
    createMockUser(9, 'Admin User', 'admin@dmistc.com', 'ADMIN'),
    createMockUser(10, 'Sys Admin', 'sysadmin@dmistc.com', 'SYSTEM_ADMIN'),
